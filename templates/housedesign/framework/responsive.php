...
$doc->addStyleSheet(JUri::base() . 'templates/' . $this->template . '/css/styles/' . "$templatestyle" . '.css', $type = 'text/css');
$doc->addStyleSheet(JUri::base() . 'templates/' . $this->template . '/css/overrides.css', $type = 'text/css');
